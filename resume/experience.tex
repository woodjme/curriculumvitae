  ...
  \cventry
    ...
    {Nov. 2018 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Lead Engineer for the Cloud Infrastructure Team tasked to architect and implement cloud infrastructure with a strong focus on \textbf{Infrastructure as Code} with \textbf{Terraform} and \textbf{Ansible} primarily in \textbf{AWS} and Azure}
        ...
        \item {Built a terminal application with \textbf{Node.js} allowing for global markets to create their own SEO redirects in \textbf{Akamai} for marketing promotions}
